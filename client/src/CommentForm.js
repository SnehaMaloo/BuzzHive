...
const CommentForm = (props) => {
    ...
    return (
    <div className={'text-buzzhive_text'}>
    ...
    <form onSubmit={e=>postComment(e)}>
        <Textarea className="w-full mb-3 border border-buzzhive_border"
        ...
        {
            !!props.onCancel &&(
                <Button outline="true" className="p-2 mr-2" onClick={e=>props.onCancel()}>Cancel</Button>
            )
        }
